...
>
  ...
  }} className="border-2 border-white text-white hover:bg-white hover:text-black px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold transition-all duration-300 hover:scale-105 inline-flex items-center justify-center space-x-2 text-sm sm:text-base w-full sm:w-auto">
...
{/* Section 4: Main Program - Wave pattern with gradient orbs */}
      ...
      <section
        ref={testimonialsRef}
        className={`relative py-12 sm:py-16 md:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden ${
          isDark ? 'bg-black' : 'bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30'
        }`}
      >
      ...
      <div className="grid md:grid-cols-2 gap-0 items-center">
        ...
        <div className="font-display p-8 sm:p-12 lg:p-16 relative z-10">
          ...
          <div className="flex items-center gap-3">
            <a href="#" className={`w-10 h-10 rounded-lg ${
